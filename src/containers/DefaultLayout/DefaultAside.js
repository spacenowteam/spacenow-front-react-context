...
import { AppSwitch } from '../CoreUI'

const DefaultAside = (props) => {

  const [_actveTab, _setActiveTab] = useState ('1')
  ...
  return (
      ...
      <React.Fragment>
        <Nav tabs>
          <NavItem>
            <NavLink className={classNames({ active: _actveTab === '1' })}
                     onClick={() => toggle('1')}>
              <i className="fa fa-list"></i>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className={classNames({ active: _actveTab === '2' })}
                     onClick={() => toggle('2')}>
              <i className="fa fa-comment"></i>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className={classNames({ active: _actveTab === '3' })}
                     onClick={() => toggle('3')}>
              <i className="fa fa-cog"></i>
            </NavLink>
          </NavItem>
        </Nav>
        <TabContent activeTab={_actveTab}>
          <TabPane tabId='1'>
            <ListGroup className="list-group-accent" tag={'div'}>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-warning list-group-item-divider">
                ...
                <small className="text-muted mr-3">
                  <i className="fa fa-calendar"></i>&nbsp; 1 - 3pm
                </small>
                <small className="text-muted">
                  <i className="fa fa-map-marker"></i> Palo Alto, CA
                </small>
              </ListGroupItem>
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-info list-group-item-divider">
                ...
                <small className="text-muted mr-3">
                  <i className="fa fa-calendar"></i>&nbsp; 4 - 5pm
                </small>
                <small className="text-muted">
                  <i className="fa fa-skype"></i> On-line
                </small>
              </ListGroupItem>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-danger list-group-item-divider">
                ...
                <small className="text-muted mr-3"><i className="fa fa-calendar"></i>&nbsp; 10 - 11pm</small>
                <small className="text-muted"><i className="fa fa-home"></i>&nbsp; creativeLabs HQ</small>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-success list-group-item-divider">
                ...
                <small className="text-muted mr-3"><i className="fa fa-calendar"></i>&nbsp; 1 - 3pm</small>
                <small className="text-muted"><i className="fa fa-map-marker"></i>&nbsp; Palo Alto, CA</small>
              </ListGroupItem>
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-primary list-group-item-divider">
                <div><strong>Team meeting</strong></div>
                <small className="text-muted mr-3"><i className="fa fa-calendar"></i>&nbsp; 4 - 6pm</small>
                <small className="text-muted"><i className="fa fa-home"></i>&nbsp; creativeLabs HQ</small>
                <div className="avatars-stack mt-2">
                  <div className="avatar avatar-xs">
                    <img src={'assets/img/avatars/2.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com" />

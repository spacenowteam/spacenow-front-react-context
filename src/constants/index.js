...
// Sidebar Login Open and Close actions
export const OPEN_LOGIN_SIDEBAR = 'OPEN_LOGIN_SIDEBAR'
export const CLOSE_LOGIN_SIDEBAR = 'CLOSE_LOGIN_SIDEBAR'

// Sidebar Signup Open and Close actions
export const OPEN_SIGNUP_SIDEBAR = 'OPEN_SIGNUP_SIDEBAR'
export const CLOSE_SIGNUP_SIDEBAR = 'CLOSE_SIGNUP_SIDEBAR'

// Sidebar Forgot Open and Close actions
export const OPEN_FORGOT_PASSWORD_SIDEBAR = 'OPEN_FORGOT_PASSWORD_SIDEBAR'
export const CLOSE_FORGOT_PASSWORD_SIDEBAR = 'CLOSE_FORGOT_PASSWORD_SIDEBAR'
...
export const CLIENT_TOKEN_START = 'CLIENT_TOKEN_START'
...
// Space Setup Page.
export const SPACE_SETUP_START = 'SPACE_SETUP_START'
...
// BookingType.
export const BOOKING_TYPE_GET_BY_SPACE_ID = 'BOOKING_TYPE_GET_BY_SPACE_ID'
export const BOOKING_TYPE_SAVED = 'BOOKING_TYPE_SAVED'
export const BOOKING_TYPE_SAVING = 'BOOKING_TYPE_SAVING'
export const BOOKING_TYPE_GET_FAILURE = 'BOOKING_TYPE_GET_FAILURE'

// Pricing.
export const PRICING_GET_BY_SPACE_ID = 'PRICING_GET_BY_SPACE_ID'
export const PRICING_SAVED = 'PRICING_SAVED'
export const PRICING_SAVING = 'PRICING_SAVING'
export const PRICING_GET_FAILURE = 'PRICING_GET_FAILURE'

// PhotosList.
export const PHOTOS_LIST_GET_BY_SPACE_ID = 'PHOTOS_LIST_GET_BY_SPACE_ID'
export const PHOTOS_LIST_SAVED = 'PHOTOS_LIST_SAVED'
export const PHOTOS_LIST_SAVING = 'PHOTOS_LIST_SAVING'
export const PHOTOS_LIST_GET_FAILURE = 'PHOTOS_LIST_GET_FAILURE'

// Fees.
export const FEES_GET_BY_SPACE_ID = 'FEES_GET_BY_SPACE_ID'
export const FEES_SAVED = 'FEES_SAVED'
export const FEES_SAVING = 'FEES_SAVING'
export const FEES_GET_FAILURE = 'FEES_GET_FAILURE'

// Aboult.
export const ABOULT_GET_BY_SPACE_ID = 'ABOULT_GET_BY_SPACE_ID'
export const ABOULT_SAVED = 'ABOULT_SAVED'
export const ABOULT_SAVING = 'ABOULT_SAVING'
export const ABOULT_GET_FAILURE = 'ABOULT_GET_FAILURE'

// AmenitiesBuilding.
export const AMENITIES_B_GET_BY_SPACE_ID = 'AMENITIES_B_GET_BY_SPACE_ID'
export const AMENITIES_B_SAVED = 'AMENITIES_B_SAVED'
export const AMENITIES_B_SAVING = 'AMENITIES_B_SAVING'
export const AMENITIES_B_GET_FAILURE = 'AMENITIES_B_GET_FAILURE'

// SpaceRules.
export const SPACE_RULES_GET_BY_SPACE_ID = 'SPACE_RULES_GET_BY_SPACE_ID'
export const SPACE_RULES_SAVED = 'SPACE_RULES_SAVED'
export const SPACE_RULES_SAVING = 'SPACE_RULES_SAVING'
export const SPACE_RULES_GET_FAILURE = 'SPACE_RULES_GET_FAILURE'

// AmenitiesSpace.
export const AMENITIES_S_GET_BY_SPACE_ID = 'AMENITIES_S_GET_BY_SPACE_ID'
export const AMENITIES_S_SAVED = 'AMENITIES_S_SAVED'
export const AMENITIES_S_SAVING = 'AMENITIES_S_SAVING'
export const AMENITIES_S_GET_FAILURE = 'AMENITIES_S_GET_FAILURE'
...
// Exceptions.
export const EXCEPTIONS_GET_BY_SPACE_ID = 'EXCEPTIONS_GET_BY_SPACE_ID'
export const EXCEPTIONS_SAVED = 'EXCEPTIONS_SAVED'
export const EXCEPTIONS_SAVING = 'EXCEPTIONS_SAVING'
export const EXCEPTIONS_GET_FAILURE = 'EXCEPTIONS_GET_FAILURE'

// AccessType.
export const ACCESS_TYPE_GET_BY_SPACE_ID = 'ACCESS_TYPE_GET_BY_SPACE_ID'
export const ACCESS_TYPE_SAVED = 'ACCESS_TYPE_SAVED'
export const ACCESS_TYPE_SAVING = 'ACCESS_TYPE_SAVING'
export const ACCESS_TYPE_GET_FAILURE = 'ACCESS_TYPE_GET_FAILURE'

// TimeTable.
export const TIME_TABLE_GET_BY_SPACE_ID = 'TIME_TABLE_GET_BY_SPACE_ID'
export const TIME_TABLE_SAVED = 'TIME_TABLE_SAVED'
export const TIME_TABLE_SAVING = 'TIME_TABLE_SAVING'
export const TIME_TABLE_GET_FAILURE = 'TIME_TABLE_GET_FAILURE'

// HolidayTable.
export const HOLIDAY_TABLE_GET_BY_SPACE_ID = 'HOLIDAY_TABLE_GET_BY_SPACE_ID'
export const HOLIDAY_TABLE_SAVED = 'HOLIDAY_TABLE_SAVED'
export const HOLIDAY_TABLE_SAVING = 'HOLIDAY_TABLE_SAVING'
export const HOLIDAY_TABLE_GET_FAILURE = 'HOLIDAY_TABLE_GET_FAILURE'
